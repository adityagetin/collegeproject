...
def get_page_heading_title():
    return html.H1(children='COVID-19 Tracker',
                   style={
                       'textAlign': 'center',
                       'color': colors['text']
                   })
...
def get_page_heading_subtitle():
    return html.Div(
        children='Visualize Covid-19 data generated from CSSE at Johns Hopkins University data all over the world.\n Designed by SRMS-CET. ',
        style={
            'textAlign': 'center',
            'color': colors['text']
        })
